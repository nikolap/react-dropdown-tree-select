!(function(e, t) {
  ...
  return (function(e) {
    ...
    function(e, t, n) {
        ...
        d = function(e, t) {
          return (
            ...
            !(function(e) {
              ...
              if (t) return t
              for (var n = e.target, r = [n]; n.parentElement; ) (n = n.parentElement), r.unshift(n)
              return r
            })(e).some(function(e) {
              return e === t
            })
      ...
      Y.propTypes = { id: l.a.string.isRequired, actions: l.a.array }
      var q = Y,
        H =
          Object.assign ||
          function(e) {
        ...
        function t() {
          ...
          return (
            ...
            (r.handleCheckboxChange = function(e) {
              ...
              'simpleSelect' === n || 'radioSelect' === n
                ? a(o, !0, !1)
                : a(o, e.target.checked, e.nativeEvent.shiftKey)
      ...
      var Te = function(e) {
        ...
        qe = function(e, t, n) {
          ...
          var r = t
          ;(function(e) {
            return Ye(e, [Be.FocusFirst, Be.FocusLast], !0)
          })(n)
            ? (r = Ee(e, 1)[0])
        ...
        He = {
          ...
          getAction: function(e, t) {
            return t === Ne
              ...
              : (function(e, t) {
                  return Ye(e, [Re, Me], t, je)
                })(t, e)
              ? Be.FocusFirst
              : (function(e, t) {
                  return Ye(e, [Ae, Fe], t, xe)
                })(t, e)
              ? Be.FocusLast
              : (function(e, t) {
                  if (!e) return Be.None
          ...
          getNextFocus: function(e, t, n, r, o) {
            ...
            return (
              (function(e) {
                return Ye(e, [Be.FocusPrevious, Be.FocusLast], !0)
              })(n) && (a = a.reverse()),
              qe(a, t, n)
            )
          },
      ...
      var $e = (function() {
          ...
          return (
            ze(e, [
              ...
              {
                key: 'regularNodeCheck',
                value: function(e, t, n) {
                  ;(n.checked = t),
                    this.showPartialState && (n.partial = !1),
                    this.toggleChildren(e, t),
              ...
              },
              {
                ...
                value: function(e, t, n) {
                  ...
                  this.simpleSelect
                    ? ((r.checked = t), this.togglePreviousChecked(e, t))
                    : this.radioSelect
                    ? (this.togglePreviousChecked(e, t),
                      this.showPartialState && this.partialCheckParents(r),
                      t || this.unCheckParents(r))
                    : (this.hierarchical || this.toggleChildren(e, t),
                      this.showPartialState && (r.partial = !1),
                      this.togglePreviousChecked(e),
                      this.regularNodeCheck(e, t, r),
                      n &&
                        null != this.lastClicked &&
                        (this.toggleBetween(e, this.lastClicked, t), this.hierarchical || t || this.unCheckParents(r)),
                      (this.lastClicked = e))
                },
              },
              {
                ...
                value: function(e, t, n) {
                  var r = this,
                    o = Array.from(this.tree, function(e) {
                      return We(e, 2)[1]
                    }).filter(function(e) {
                      return !e.hide
                    }),
                    a = [o.indexOf(this.getNodeById(e)), o.indexOf(this.getNodeById(t))].sort(function(e, t) {
                      return e - t
                    }),
                    i = We(a, 2),
                    l = i[0],
        ...
        function t(e) {
          ...
          return (
            ...
            (n.onTagRemove = function(e, t) {
              var r = n.state.tags
              n.onCheckboxChange(e, !1, !1, function(o) {
            ...
            (n.onCheckboxChange = function(e, t, r, o) {
              var a = n.props,
                i = a.mode,
                l = a.keepOpenOnSelect,
                s = n.props.shiftClick && r
              n.treeManager.setNodeCheckedState(e, t, s)
              var c = n.treeManager.tags,
                u = ['simpleSelect', 'radioSelect'].indexOf(i) > -1,
                h = !(u && !l) && n.state.showDropdown
              c.length || (n.treeManager.restoreDefaultValues(), (c = n.treeManager.tags))
              var d = {
                tree: n.state.searchModeOn ? n.treeManager.matchTree : n.treeManager.tree,
                tags: c,
                showDropdown: h,
              }
              ;((u && !h) || n.props.clearSearchOnChange) && Object.assign(d, n.resetSearchState()),
                u && !h && document.removeEventListener('click', n.handleOutsideClick, !1),
                n.setState(d, function() {
                  o && o(c)
                }),
                n.props.onChange(n.treeManager.getNodeById(e), c)
            }),
                ...
                return c.a.createElement(
                  'div',
                  {
                    ...
                    className: [
                      ...
                      'react-dropdown-tree-select',
                      this.props.shiftClick && 'no-highlight',
                    ]
                      .filter(Boolean)
                      .join(' '),
                    ref: function(t) {
                  ...
                  c.a.createElement(
                    ...
                    c.a.createElement(
                      I,
                      Je({ onTrigger: this.onTrigger, showDropdown: s }, d, { tags: h }),
                      c.a.createElement(E, Je({ tags: h, onTagRemove: this.onTagRemove }, d), !i && p)
                    ),
                    s &&
                      c.a.createElement(
                        'div',
